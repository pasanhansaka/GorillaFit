      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-6">
              Elevate your fitness journey with state-of-the-art equipment and expert guidance at Gorilla Fitness.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><span className="text-gray-400">Weight Lifting</span></li>
              <li><span className="text-gray-400">Cardio Fitness</span></li>
              <li><span className="text-gray-400">Yoga & Pilates</span></li>
              <li><span className="text-gray-400">Nutrition Plans</span></li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              <li className="flex">
                <span className="text-gray-400 break-words">
                  123 Fitness Street, Gym District,<br />Workout City, 10001
                </span>
              </li>
              <li>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Gorilla Fitness. All rights reserved.
          </p>
